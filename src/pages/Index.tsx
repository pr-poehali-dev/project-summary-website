        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 leading-tight bg-clip-text text-transparent bg-gradient-to-r from-purple-600 via-indigo-500 to-purple-600">
              Курс лекций на тему исторических мифов. Мифоделик
            </h1>

            <p className="text-xl text-gray-600 mb-10 leading-relaxed">
              Погрузитесь в увлекательное путешествие по историческим мифам и
              легендам, раскрывающее истину, скрытую за завесой времени
            </p>
            ...
            <div className="flex flex-wrap justify-center gap-4">
              ...
              <Button
                variant="outline"
                className="text-lg px-8 py-6 border-purple-300"
              >
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Наш проект предлагает набор инновационных функций, разработанных
            ...
            {[
              {
                ...
                description:
                  "Интерфейс автоматически подстраивается под любые устройства и размеры экранов",
              },
              {
                icon: "Zap",
                title: "Высокая производительность",
                description:
                  "Оптимизированный код обеспечивает молниеносную загрузку и работу приложения",
              },
              {
                icon: "Shield",
                title: "Безопасность данных",
                description:
                  "Современные протоколы шифрования для защиты всей пользовательской информации",
              },
              {
                icon: "Users",
                title: "Командная работа",
                description:
                  "Инструменты для эффективного взаимодействия в команде разработчиков",
              },
              {
                icon: "Code",
                title: "Чистый код",
                description:
                  "Следование лучшим практикам для создания поддерживаемого кодового базиса",
              },
              {
                icon: "BarChart2",
                title: "Аналитика",
                description:
                  "Встроенные инструменты анализа данных для принятия обоснованных решений",
              },
            ].map((feature, index) => (
              <div
                key={index}
      ...
      <section id="tech" className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Мы используем передовые технологии для создания надежных и
          ...
          <div className="flex flex-col md:flex-row justify-between mb-8">
            <div className="mb-8 md:mb-0">
              <div className="flex items-center gap-2 mb-4">
                ...
                <h1 className="text-xl font-bold text-white">Проект.Резюме</h1>
              </div>
              <p className="text-gray-400 max-w-sm">
                Инновационное решение для разработки цифровых продуктов с
